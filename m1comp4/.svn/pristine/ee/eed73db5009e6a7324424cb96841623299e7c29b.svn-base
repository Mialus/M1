...
// Regles
 ...
 jjtn000.jjtSetFirstToken(getToken(1));Token t;
  ...
  final public SimpleNode objet() throws ParseException {
                      /*@bgen(jjtree) objet */
                      ASTobjet jjtn000 = new ASTobjet(JJTOBJET);
                      boolean jjtc000 = true;
                      jjtree.openNodeScope(jjtn000);
                      jjtn000.jjtSetFirstToken(getToken(1));Token t;
    try {
  ...
  final public SimpleNode adresse() throws ParseException {
 /*@bgen(jjtree) adresse */
 ...
 jjtn000.jjtSetFirstToken(getToken(1));Token t;
  ...
  final public SimpleNode instrs() throws ParseException {
    ...
    case NEW:
      ...
      jj_consume_token(VIRG);
      adresse();
                                                                               ASTnewVal jjtn003 = new ASTnewVal(JJTNEWVAL);
  ...
  final public SimpleNode valeur() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NOMBRE:
      nbre();
      break;
  ...
  final public SimpleNode oper1() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NEG:
  ...
  final public SimpleNode oper2() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ADD:
  ...
  final public SimpleNode nbre() throws ParseException {
 /*@bgen(jjtree) nbre */
 ...
 jjtn000.jjtSetFirstToken(getToken(1));Token t;
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x200000,0x0,0x0,0x0,0xffffa,0x200005,0x0,0x0,0x0,};
   }
