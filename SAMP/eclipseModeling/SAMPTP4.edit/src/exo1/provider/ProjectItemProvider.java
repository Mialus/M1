...
/**
 * This is the item provider adapter for a {@link exo1.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDepartementPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Exo1Package.Literals.PROJECT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addBudgetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_budget_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_budget_feature", "_UI_Project_type"),
				 Exo1Package.Literals.PROJECT__BUDGET,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Departement feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDepartementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_departement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_departement_feature", "_UI_Project_type"),
				 Exo1Package.Literals.PROJECT__DEPARTEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEmployeesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_employees_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_employees_feature", "_UI_Project_type"),
				 Exo1Package.Literals.PROJECT__EMPLOYEES,
				 true,
				 false,
				 true,
				 null,
